...
class ProductTemplateImporter(ProductImporter): 
    ...
    def set_configurable_product_data_after_import(self,binding,record):
        ...
        binding.erp_id.write({'name' : binding.magento_product_name})
        for variant in binding.erp_id.product_variant_ids :
            if variant.default_code == False or variant.default_code == '':
