{
    ...
    # Dependencies
    'depends': ['delivery','stock','sale_management','base_sparse_field','auto_invoice_workflow_ept'],
    'data':[
            'views/automatic_workflow_process.xml',
            ...
            'views/product/product_url_view.xml',
            ...
            #'automatic_workflow_process.xml'
            ],

    # Odoo Store Specific
    
    'images': ['static/description/magento2-odoo-cover.jpg'],
    'installable': True,
    'auto_install': False,
    'application' : True,
    'live_test_url':'http://www.emiprotechnologies.com/free-trial?app=odoo-magento2-ept&version=11',
    'price': 649.00,
    'currency': 'EUR',
